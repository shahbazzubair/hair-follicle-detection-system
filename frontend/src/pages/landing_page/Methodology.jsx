      ...
      <div className={styles.container}>
        ...
        <div className={styles.workflowGrid}>
          <div className={styles.stepCard}>
            ...
            <div className={styles.stepVisual}><img src="/assets/PS.png" alt="Patient Signup" /></div>
          </div>
          ...
          <div className={styles.stepCard}>
            ...
            <div className={styles.stepVisual}><img src="/assets/PL.png" alt="Patient Login" /></div>
          </div>
          ...
          <div className={styles.stepCard}>
            ...
            <div className={styles.stepVisual}><img src="/assets/SS.png" alt="Select Specialist" /></div>
          </div>
